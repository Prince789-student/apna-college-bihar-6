 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc=new Dm("@firebase/auth");function vN(t,...e){rc.logLevel<=oe.WARN&&rc.warn(`Auth (${Zi}): ${t}`,...e)}function fu(t,...e){rc.logLevel<=oe.ERROR&&rc.error(`Auth (${Zi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bj(t,e){if($e(t.app))return Promise.reject(Tt(t));const n=tt(t),r=await PO(n,{token:e,returnSecureToken:!0}),i=await Ln._fromIdTokenResponse(n,"signIn",r);return await n._updateCurrentUser(i.user),i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qj(t,e,n){const r=tt(t),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,l){B(l.handleCodeInApp,r,"argument-error"),l&&Yc(r,o,l)}s(i,n),await Wr(r,i,"getOobCode",mO,"EMAIL_PASSWORD_PROVIDER")}function Kj(t,e){const n=Kc.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function Gj(t,e,n){if($e(t.app))return Promise.reject(Tt(t));const r=ne(t),i=es.credentialWithLink(e,n||ja());return B(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Qc(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qj(t,e){const n=Um()?ja():"http://localhost",r={identifier:e,continueUri:n},{signinMethods:i}=await xO(ne(t),r);return i||[]}async function Yj(t,e){const n=ne(t),i={requestType:"VERIFY_EMAIL",idToken:await t.getIdToken()};e&&Yc(n.auth,i,e);const{email:s}=await fO(n.auth,i);s!==t.email&&await t.reload()}async function Jj(t,e,n){const r=ne(t),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await t.getIdToken(),newEmail:e};n&&Yc(r.auth,s,n);const{email:o}=await gO(r.auth,s);o!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xj(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=ne(t),s={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await Ui(r,NO(r.auth,s));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const l=r.providerData.find(({providerId:u})=>u==="password");l&&(l.displayName=r.displayName,l.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function Zj(t,e){const n=ne(t);return $e(n.auth.app)?Promise.reject(Tt(n.auth)):BI(n,e,null)}function e6(t,e){return BI(ne(t),null,e)}async function BI(t,e,n){const{auth:r}=t,s={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(s.email=e),n&&(s.password=n);const o=await Ui(t,uO(r,s));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OO(t){var i,s;if(!t)return null;const{providerId:e}=t,n=t.rawUserInfo?JSON.parse(t.rawUserInfo):{},r=t.isNewUser||t.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(t!=null&&t.idToken)){const o=(s=(i=Hc(t.idToken))==null?void 0:i.firebase)==null?void 0:s.sign_in_provider;if(o){const l=o!=="anonymous"&&o!=="custom"?o:null;return new Os(r,l)}}if(!e)return null;switch(e){case"facebook.com":return new DO(r,n);case"github.com":return new LO(r,n);case"google.com":return new VO(r,n);case"twitter.com":return new MO(r,n,t.screenName||null);case"custom":case"anonymous":return new Os(r,null);default:return new Os(r,e,n)}}class Os{constructor(e,n,r={}){this.isNewUser=e,this.providerId=n,this.profile=r}}class zI extends Os{constructor(e,n,r,i){super(e,n,r),this.username=i}}class DO extends Os{constructor(e,n){super(e,"facebook.com",n)}}class LO extends zI{constructor(e,n){super(e,"github.com",n,typeof(n==null?void 0:n.login)=="string"?n==null?void 0:n.login:null)}}class VO extends Os{constructor(e,n){super(e,"google.com",n)}}class MO extends zI{constructor(e,n,r){super(e,"twitter.com",n,r)}}function t6(t){const{user:e,_tokenResponse:n}=t;return e.isAnonymous&&!n?{providerId:null,isNewUser:!1,profile:null}:OO(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uh{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,dl.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new uh(Z.min(),i,new Pe(ae),or(),le())}}class dl{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new dl(r,n,le(),le(),le())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rg extends RM{constructor(e){super(),this.firestore=e}convertBytes(e){return new Jt(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ne(this.firestore,null,n)}}function Fw(){return new Tg("serverTimestamp")}function l6(...t){return new Ig("arrayUnion",t)}function u6(t){return new Sg("increment",t)}const jw="@firebase/firestore",$w="4.13.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n1="storage";function y6(t,e,n){return t=ne(t),bU(t,e,n)}function _6(t){return t=ne(t),xU(t)}function v6(t,e){return t=ne(t),LU(t,e)}function MU(t=Bc(),e){t=ne(t);const r=Xi(t,n1).getImmediate({identifier:e}),i=sI("storage");return i&&UU(r,...i),r}function UU(t,e,n,r={}){VU(t,e,n,r)}function FU(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new Vg(n,r,i,e,Zi)}function jU(){_n(new rn(n1,FU,"PUBLIC").setMultipleInstances(!0)),Dt(Qw,Yw,""),Dt(Qw,Yw,"esm2020")}jU();const r1="@firebase/installations",Mg="0.6.21";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
