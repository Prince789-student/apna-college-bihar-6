 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jj(t,e,n){const r=rt(t),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,l){z(l.handleCodeInApp,r,"argument-error"),l&&Jc(r,o,l)}s(i,n),await Kr(r,i,"getOobCode",gO,"EMAIL_PASSWORD_PROVIDER")}function Xj(t,e){const n=Gc.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function Zj(t,e,n){if(ze(t.app))return Promise.reject(At(t));const r=re(t),i=es.credentialWithLink(e,n||$a());return z(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Yc(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ha=-1;function AL(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,i=ee.fromTimestamp(r===1e9?new Te(n+1,0):new Te(n,r));return new ei(i,Y.empty(),e)}function RL(t){return new ei(t.readTime,t.key,Ha)}class ei{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new ei(ee.min(),Y.empty(),Ha)}static max(){return new ei(ee.max(),Y.empty(),Ha)}}function kL(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=Y.comparator(t.documentKey,e.documentKey),n!==0?n:le(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t2=new be(Y.comparator);function lr(){return t2}const MS=new be(Y.comparator);function ea(...t){let e=MS;for(const n of t)e=e.insert(n.key,n);return e}function US(t){let e=MS;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Ri(){return _a()}function FS(){return _a()}function _a(){return new ts(t=>t.toString(),(t,e)=>t.isEqual(e))}const n2=new be(Y.comparator),r2=new Qe(Y.comparator);function ue(...t){let e=r2;for(const n of t)e=e.add(n);return e}const i2=new Qe(le);function s2(){return i2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
