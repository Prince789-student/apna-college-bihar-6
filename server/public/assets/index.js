 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qj(t,e,n){const r=tt(t),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,l){B(l.handleCodeInApp,r,"argument-error"),l&&Jc(r,o,l)}s(i,n),await Wr(r,i,"getOobCode",mO,"EMAIL_PASSWORD_PROVIDER")}function Kj(t,e){const n=Gc.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function Gj(t,e,n){if($e(t.app))return Promise.reject(Tt(t));const r=ne(t),i=es.credentialWithLink(e,n||ja());return B(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Yc(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qj(t,e){const n=Um()?ja():"http://localhost",r={identifier:e,continueUri:n},{signinMethods:i}=await xO(ne(t),r);return i||[]}async function Yj(t,e){const n=ne(t),i={requestType:"VERIFY_EMAIL",idToken:await t.getIdToken()};e&&Jc(n.auth,i,e);const{email:s}=await fO(n.auth,i);s!==t.email&&await t.reload()}async function Jj(t,e,n){const r=ne(t),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await t.getIdToken(),newEmail:e};n&&Jc(r.auth,s,n);const{email:o}=await gO(r.auth,s);o!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
