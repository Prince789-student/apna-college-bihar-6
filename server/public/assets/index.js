 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yF(t,e){if(Be(t.app))return Promise.reject(Tt(t));const n=tt(t),r=await bx(n,{token:e,returnSecureToken:!0}),i=await Dn._fromIdTokenResponse(n,"signIn",r);return await n._updateCurrentUser(i.user),i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function EF(t,e,n){const r=tt(t),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,l){$(l.handleCodeInApp,r,"argument-error"),l&&Lc(r,o,l)}s(i,n),await $r(r,i,"getOobCode",_x,"EMAIL_PASSWORD_PROVIDER")}function TF(t,e){const n=xc.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function IF(t,e,n){if(Be(t.app))return Promise.reject(Tt(t));const r=ee(t),i=Yi.credentialWithLink(e,n||Na());return $(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Oc(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SF(t,e){const n=cm()?Na():"http://localhost",r={identifier:e,continueUri:n},{signinMethods:i}=await Ox(ee(t),r);return i||[]}async function AF(t,e){const n=ee(t),i={requestType:"VERIFY_EMAIL",idToken:await t.getIdToken()};e&&Lc(n.auth,i,e);const{email:s}=await gx(n.auth,i);s!==t.email&&await t.reload()}async function RF(t,e,n){const r=ee(t),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await t.getIdToken(),newEmail:e};n&&Lc(r.auth,s,n);const{email:o}=await vx(r.auth,s);o!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kF(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=ee(t),s={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await Oi(r,Lx(r.auth,s));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const l=r.providerData.find(({providerId:u})=>u==="password");l&&(l.displayName=r.displayName,l.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function PF(t,e){const n=ee(t);return Be(n.auth.app)?Promise.reject(Tt(n.auth)):ZT(n,e,null)}function CF(t,e){return ZT(ee(t),null,e)}async function ZT(t,e,n){const{auth:r}=t,s={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(s.email=e),n&&(s.password=n);const o=await Oi(t,dx(r,s));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
