...
*/var Yr,hS;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,y){function E(){}E.prototype=y.prototype,I.F=y.prototype,I.prototype=new E,I.prototype.constructor=I,I.D=function(k,R,x){for(var S=Array(arguments.length-2),re=2;re<arguments.length;re++)S[re-2]=arguments[re];return y.prototype[R].apply(k,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,y,E){E||(E=0);const k=Array(16);if(typeof y=="string")for(var R=0;R<16;++R)k[R]=y.charCodeAt(E++)|y.charCodeAt(E++)<<8|y.charCodeAt(E++)<<16|y.charCodeAt(E++)<<24;else for(R=0;R<16;++R)k[R]=y[E++]|y[E++]<<8|y[E++]<<16|y[E++]<<24;y=I.g[0],E=I.g[1],R=I.g[2];let x=I.g[3],S;S=y+(x^E&(R^x))+k[0]+3614090360&4294967295,y=E+(S<<7&4294967295|S>>>25),S=x+(R^y&(E^R))+k[1]+3905402710&4294967295,x=y+(S<<12&4294967295|S>>>20),S=R+(E^x&(y^E))+k[2]+606105819&4294967295,R=x+(S<<17&4294967295|S>>>15),S=E+(y^R&(x^y))+k[3]+3250441966&4294967295,E=R+(S<<22&4294967295|S>>>10),S=y+(x^E&(R^x))+k[4]+4118548399&4294967295,y=E+(S<<7&4294967295|S>>>25),S=x+(R^y&(E^R))+k[5]+1200080426&4294967295,x=y+(S<<12&4294967295|S>>>20),S=R+(E^x&(y^E))+k[6]+2821735955&4294967295,R=x+(S<<17&4294967295|S>>>15),S=E+(y^R&(x^y))+k[7]+4249261313&4294967295,E=R+(S<<22&4294967295|S>>>10),S=y+(x^E&(R^x))+k[8]+1770035416&4294967295,y=E+(S<<7&4294967295|S>>>25),S=x+(R^y&(E^R))+k[9]+2336552879&4294967295,x=y+(S<<12&4294967295|S>>>20),S=R+(E^x&(y^E))+k[10]+4294925233&4294967295,R=x+(S<<17&4294967295|S>>>15),S=E+(y^R&(x^y))+k[11]+2304563134&4294967295,E=R+(S<<22&4294967295|S>>>10),S=y+(x^E&(R^x))+k[12]+1804603682&4294967295,y=E+(S<<7&4294967295|S>>>25),S=x+(R^y&(E^R))+k[13]+4254626195&4294967295,x=y+(S<<12&4294967295|S>>>20),S=R+(E^x&(y^E))+k[14]+2792965006&4294967295,R=x+(S<<17&4294967295|S>>>15),S=E+(y^R&(x^y))+k[15]+1236535329&4294967295,E=R+(S<<22&4294967295|S>>>10),S=y+(R^x&(E^R))+k[1]+4129170786&4294967295,y=E+(S<<5&4294967295|S>>>27),S=x+(E^R&(y^E))+k[6]+3225465664&4294967295,x=y+(S<<9&4294967295|S>>>23),S=R+(y^E&(x^y))+k[11]+643717713&4294967295,R=x+(S<<14&4294967295|S>>>18),S=E+(x^y&(R^x))+k[0]+3921069994&4294967295,E=R+(S<<20&4294967295|S>>>12),S=y+(R^x&(E^R))+k[5]+3593408605&4294967295,y=E+(S<<5&4294967295|S>>>27),S=x+(E^R&(y^E))+k[10]+38016083&4294967295,x=y+(S<<9&4294967295|S>>>23),S=R+(y^E&(x^y))+k[15]+3634488961&4294967295,R=x+(S<<14&4294967295|S>>>18),S=E+(x^y&(R^x))+k[4]+3889429448&4294967295,E=R+(S<<20&4294967295|S>>>12),S=y+(R^x&(E^R))+k[9]+568446438&4294967295,y=E+(S<<5&4294967295|S>>>27),S=x+(E^R&(y^E))+k[14]+3275163606&4294967295,x=y+(S<<9&4294967295|S>>>23),S=R+(y^E&(x^y))+k[3]+4107603335&4294967295,R=x+(S<<14&4294967295|S>>>18),S=E+(x^y&(R^x))+k[8]+1163531501&4294967295,E=R+(S<<20&4294967295|S>>>12),S=y+(R^x&(E^R))+k[13]+2850285829&4294967295,y=E+(S<<5&4294967295|S>>>27),S=x+(E^R&(y^E))+k[2]+4243563512&4294967295,x=y+(S<<9&4294967295|S>>>23),S=R+(y^E&(x^y))+k[7]+1735328473&4294967295,R=x+(S<<14&4294967295|S>>>18),S=E+(x^y&(R^x))+k[12]+2368359562&4294967295,E=R+(S<<20&4294967295|S>>>12),S=y+(E^R^x)+k[5]+4294588738&4294967295,y=E+(S<<4&4294967295|S>>>28),S=x+(y^E^R)+k[8]+2272392833&4294967295,x=y+(S<<11&4294967295|S>>>21),S=R+(x^y^E)+k[11]+1839030562&4294967295,R=x+(S<<16&4294967295|S>>>16),S=E+(R^x^y)+k[14]+4259657740&4294967295,E=R+(S<<23&4294967295|S>>>9),S=y+(E^R^x)+k[1]+2763975236&4294967295,y=E+(S<<4&4294967295|S>>>28),S=x+(y^E^R)+k[4]+1272893353&4294967295,x=y+(S<<11&4294967295|S>>>21),S=R+(x^y^E)+k[7]+4139469664&4294967295,R=x+(S<<16&4294967295|S>>>16),S=E+(R^x^y)+k[10]+3200236656&4294967295,E=R+(S<<23&4294967295|S>>>9),S=y+(E^R^x)+k[13]+681279174&4294967295,y=E+(S<<4&4294967295|S>>>28),S=x+(y^E^R)+k[0]+3936430074&4294967295,x=y+(S<<11&4294967295|S>>>21),S=R+(x^y^E)+k[3]+3572445317&4294967295,R=x+(S<<16&4294967295|S>>>16),S=E+(R^x^y)+k[6]+76029189&4294967295,E=R+(S<<23&4294967295|S>>>9),S=y+(E^R^x)+k[9]+3654602809&4294967295,y=E+(S<<4&4294967295|S>>>28),S=x+(y^E^R)+k[12]+3873151461&4294967295,x=y+(S<<11&4294967295|S>>>21),S=R+(x^y^E)+k[15]+530742520&4294967295,R=x+(S<<16&4294967295|S>>>16),S=E+(R^x^y)+k[2]+3299628645&4294967295,E=R+(S<<23&4294967295|S>>>9),S=y+(R^(E|~x))+k[0]+4096336452&4294967295,y=E+(S<<6&4294967295|S>>>26),S=x+(E^(y|~R))+k[7]+1126891415&4294967295,x=y+(S<<10&4294967295|S>>>22),S=R+(y^(x|~E))+k[14]+2878612391&4294967295,R=x+(S<<15&4294967295|S>>>17),S=E+(x^(R|~y))+k[5]+4237533241&4294967295,E=R+(S<<21&4294967295|S>>>11),S=y+(R^(E|~x))+k[12]+1700485571&4294967295,y=E+(S<<6&4294967295|S>>>26),S=x+(E^(y|~R))+k[3]+2399980690&4294967295,x=y+(S<<10&4294967295|S>>>22),S=R+(y^(x|~E))+k[10]+4293915773&4294967295,R=x+(S<<15&4294967295|S>>>17),S=E+(x^(R|~y))+k[1]+2240044497&4294967295,E=R+(S<<21&4294967295|S>>>11),S=y+(R^(E|~x))+k[8]+1873313359&4294967295,y=E+(S<<6&4294967295|S>>>26),S=x+(E^(y|~R))+k[15]+4264355552&4294967295,x=y+(S<<10&4294967295|S>>>22),S=R+(y^(x|~E))+k[6]+2734768916&4294967295,R=x+(S<<15&4294967295|S>>>17),S=E+(x^(R|~y))+k[13]+1309151649&4294967295,E=R+(S<<21&4294967295|S>>>11),S=y+(R^(E|~x))+k[4]+4149444226&4294967295,y=E+(S<<6&4294967295|S>>>26),S=x+(E^(y|~R))+k[11]+3174756917&4294967295,x=y+(S<<10&4294967295|S>>>22),S=R+(y^(x|~E))+k[2]+718787259&4294967295,R=x+(S<<15&4294967295|S>>>17),S=E+(x^(R|~y))+k[9]+3951481745&4294967295,I.g[0]=I.g[0]+y&4294967295,I.g[1]=I.g[1]+(R+(S<<21&4294967295|S>>>11))&4294967295,I.g[2]=I.g[2]+R&4294967295,I.g[3]=I.g[3]+x&4294967295}r.prototype.v=function(I,y){y===void 0&&(y=I.length);const E=y-this.blockSize,k=this.C;let R=this.h,x=0;for(;x<y;){if(R==0)for(;x<=E;)i(this,I,x),x+=this.blockSize;if(typeof I=="string"){for(;x<y;)if(k[R++]=I.charCodeAt(x++),R==this.blockSize){i(this,k),R=0;break}}else for(;x<y;)if(k[R++]=I[x++],R==this.blockSize){i(this,k),R=0;break}}this.h=R,this.o+=y},r.prototype.A=function(){var I=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);I[0]=128;for(var y=1;y<I.length-8;++y)I[y]=0;y=this.o*8;for(var E=I.length-8;E<I.length;++E)I[E]=y&255,y/=256;for(this.v(I),I=Array(16),y=0,E=0;E<4;++E)for(let k=0;k<32;k+=8)I[y++]=this.g[E]>>>k&255;return I};function s(I,y){var E=l;return Object.prototype.hasOwnProperty.call(E,I)?E[I]:E[I]=y(I)}function o(I,y){this.h=y;const E=[];let k=!0;for(let R=I.length-1;R>=0;R--){const x=I[R]|0;k&&x==y||(E[R]=x,k=!1)}this.g=E}var l={};function u(I){return-128<=I&&I<128?s(I,function(y){return new o([y|0],y<0?-1:0)}):new o([I|0],I<0?-1:0)}function c(I){if(isNaN(I)||!isFinite(I))return f;if(I<0)return b(c(-I));const y=[];let E=1;for(let k=0;I>=E;k++)y[k]=I/E|0,E*=4294967296;return new o(y,0)}function d(I,y){if(I.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(I.charAt(0)=="-")return b(d(I.substring(1),y));if(I.indexOf("-")>=0)throw Error('number format error: interior "-" character');const E=c(Math.pow(y,8));let k=f;for(let x=0;x<I.length;x+=8){var R=Math.min(8,I.length-x);const S=parseInt(I.substring(x,x+R),y);R<8?(R=c(Math.pow(y,R)),k=k.j(R).add(c(S))):(k=k.j(E),k=k.add(c(S)))}return k}var f=u(0),m=u(1),w=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-b(this).m();let I=0,y=1;for(let E=0;E<this.g.length;E++){const k=this.i(E);I+=(k>=0?k:4294967296+k)*y,y*=4294967296}return I},t.toString=function(I){if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(C(this))return"0";if(P(this))return"-"+b(this).toString(I);const y=c(Math.pow(I,6));var E=this;let k="";for(;;){const R=O(E,y).g;E=v(E,R.j(y));let x=((E.g.length>0?E.g[0]:E.h)>>>0).toString(I);if(E=R,C(E))return x+k;for(;x.length<6;)x="0"+x;k=x+k}},t.i=function(I){return I<0?0:I<this.g.length?this.g[I]:this.h};function C(I){if(I.h!=0)return!1;for(let y=0;y<I.g.length;y++)if(I.g[y]!=0)return!1;return!0}function P(I){return I.h==-1}t.l=function(I){return I=v(this,I),P(I)?-1:C(I)?0:1};function b(I){const y=I.g.length,E=[];for(let k=0;k<y;k++)E[k]=~I.g[k];return new o(E,~I.h).add(m)}t.abs=function(){return P(this)?b(this):this},t.add=function(I){const y=Math.max(this.g.length,I.g.length),E=[];let k=0;for(let R=0;R<=y;R++){let x=k+(this.i(R)&65535)+(I.i(R)&65535),S=(x>>>16)+(this.i(R)>>>16)+(I.i(R)>>>16);k=S>>>16,x&=65535,S&=65535,E[R]=S<<16|x}return new o(E,E[E.length-1]&-2147483648?-1:0)};function v(I,y){return I.add(b(y))}t.j=function(I){if(C(this)||C(I))return f;if(P(this))return P(I)?b(this).j(b(I)):b(b(this).j(I));if(P(I))return b(this.j(b(I)));if(this.l(w)<0&&I.l(w)<0)return c(this.m()*I.m());const y=this.g.length+I.g.length,E=[];for(var k=0;k<2*y;k++)E[k]=0;for(k=0;k<this.g.length;k++)for(let R=0;R<I.g.length;R++){const x=this.i(k)>>>16,S=this.i(k)&65535,re=I.i(R)>>>16,me=I.i(R)&65535;E[2*k+2*R]+=S*me,_(E,2*k+2*R),E[2*k+2*R+1]+=x*me,_(E,2*k+2*R+1),E[2*k+2*R+1]+=S*re,_(E,2*k+2*R+1),E[2*k+2*R+2]+=x*re,_(E,2*k+2*R+2)}for(I=0;I<y;I++)E[I]=E[2*I+1]<<16|E[2*I];for(I=y;I<2*y;I++)E[I]=0;return new o(E,0)};function _(I,y){for(;(I[y]&65535)!=I[y];)I[y+1]+=I[y]>>>16,I[y]&=65535,y++}function T(I,y){this.g=I,this.h=y}function O(I,y){if(C(y))throw Error("division by zero");if(C(I))return new T(f,f);if(P(I))return y=O(b(I),y),new T(b(y.g),b(y.h));if(P(y))return y=O(I,b(y)),new T(b(y.g),y.h);if(I.g.length>30){if(P(I)||P(y))throw Error("slowDivide_ only works with positive integers.");for(var E=m,k=y;k.l(I)<=0;)E=U(E),k=U(k);var R=B(E,1),x=B(k,1);for(k=B(k,2),E=B(E,2);!C(k);){var S=x.add(k);S.l(I)<=0&&(R=R.add(E),x=S),k=B(k,1),E=B(E,1)}return y=v(I,R.j(y)),new T(R,y)}for(R=f;I.l(y)>=0;){for(E=Math.max(1,Math.floor(I.m()/y.m())),k=Math.ceil(Math.log(E)/Math.LN2),k=k<=48?1:Math.pow(2,k-48),x=c(E),S=x.j(y);P(S)||S.l(I)>0;)E-=k,x=c(E),S=x.j(y);C(x)&&(x=m),R=R.add(x),I=v(I,S)}return new T(R,I)}t.B=function(I){return O(this,I).h},t.and=function(I){const y=Math.max(this.g.length,I.g.length),E=[];for(let k=0;k<y;k++)E[k]=this.i(k)&I.i(k);return new o(E,this.h&I.h)},t.or=function(I){const y=Math.max(this.g.length,I.g.length),E=[];for(let k=0;k<y;k++)E[k]=this.i(k)|I.i(k);return new o(E,this.h|I.h)},t.xor=function(I){const y=Math.max(this.g.length,I.g.length),E=[];for(let k=0;k<y;k++)E[k]=this.i(k)^I.i(k);return new o(E,this.h^I.h)};function U(I){const y=I.g.length+1,E=[];for(let k=0;k<y;k++)E[k]=I.i(k)<<1|I.i(k-1)>>>31;return new o(E,I.h)}function B(I,y){const E=y>>5;y%=32;const k=I.g.length-E,R=[];for(let x=0;x<k;x++)R[x]=y>0?I.i(x+E)>>>y|I.i(x+E+1)<<32-y:I.i(x+E);return new o(R,I.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,hS=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,Yr=o}).apply(typeof Gv<"u"?Gv:typeof self<"u"?self:typeof window<"u"?window:{});var Zl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
