 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dF(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===sl.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(aE(n)):t.onMessageHandler.next(aE(n)));const r=n.data;nF(r)&&r[V4]==="1"&&await cF(t,n.messageType,r)}const lE="@firebase/messaging",uE="0.12.25";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
