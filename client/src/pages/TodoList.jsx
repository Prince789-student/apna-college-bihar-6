  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-200/50 mt-12 max-w-4xl mx-auto prose prose-slate max-w-none shadow-sm mb-12 text-left">
        <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tighter mb-4">Ultimate Engineering To-Do List & Task Manager</h2>
        <p>
          Managing daily assignments, grueling lab reports, tricky mid-semester exams, and major technical projects simultaneously can quickly become chaotic for any B.Tech student at Bihar Engineering University (BEU). Our dedicated <strong>Student To-Do List</strong> is meticulously designed to help you organize your academic life efficiently and ensure you never miss a critical submission deadline again.
        </p>

        <h3 className="text-xl font-bold mt-8 mb-4">How to Prioritize Daily Academic Targets</h3>
        <p>
          We highly recommend using the Eisenhower Matrix technique for daily task prioritization:
        </p>
        <ul>
          <li><strong>Urgent & Important:</strong> Lab reports due tomorrow morning, upcoming class tests, project presentations. Do these first.</li>
          <li><strong>Important, Not Urgent:</strong> Studying for end-semester exams weeks in advance, working on a major capstone software project. Schedule dedicated time for these.</li>
          <li><strong>Urgent, Not Important:</strong> Basic administrative tasks, certain college emails. Delegate or finish these as quickly as possible.</li>
        </ul>

        <h3 className="text-xl font-bold mt-8 mb-4">The Psychological Benefit of Micro-Tasking</h3>
        <p>
          Instead of writing a massive task like "Study Engineering Mathematics", break it down into micro-tasks such as "Solve 5 problems on Laplace Transforms". Micro-tasking makes your daily targets far more achievable, triggers a natural dopamine release when you check off the completed task, and significantly reduces academic anxiety. Use this list every single morning to set the tone for a productive day!
        </p>
      </div>
