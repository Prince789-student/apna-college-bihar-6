...
function UgeacPredictor() {
  ...
  const downloadResultsPDF = async () => {
    ...
    let logoData = null;
    try {
      const resp = await fetch('/logo-acb.png?v=99?v=99');
      if (resp.ok) {
    ...
    <div className="main-app-container">
      ...
      <>
              ...
              <div className="flex justify-center mb-8">
                 <div className="relative group">
                    ...
                    <div className="bg-slate-900/50 p-2 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden floating-icon">
                       <img src="/logo-acb.png?v=99?v=99" alt="Logo" className="w-20 h-20 rounded-2xl" />
                    </div>
                 </div>
              </div>
        ...
        <footer className="mt-32 py-16 border-t border-white/5 text-center">
           <img src="/logo-acb.png?v=99?v=99" alt="Logo" className="w-14 h-14 rounded-full mx-auto mb-8 grayscale opacity-30 hover:opacity-100 transition-opacity" />
