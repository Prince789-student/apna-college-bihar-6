...
function UgeacPredictor() {
  ...
  return (
    <div className="main-app-container pt-8">
      <header className="app-header">
        <h1>UGEAC COUNSELLING</h1>
        <p>Bihar Engineering Admission Predictor & Smart Choice Filling</p>
                 ...
                 <table>
                   ...
                   <tbody>
                     {results.all.map((item, index) => (
                       <tr key={index}>
                         <td style={{ fontWeight: 600 }}>{item.college.name}</td>
                         <td>{item.branch}</td>
                         <td>
          ...
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="infra-section">
                <h4 style={{ margin: '15px 0 10px 0'}}>🏢 Infrastructure & Facilities</h4>
              ...
              <div className="pros-cons" style={{ marginTop: '20px' }}>
                 ...
                 <div className="cons">
                   <h4 style={{ color: '#991b1b'}}>⚠️ Cons</h4>
                   <ul>
