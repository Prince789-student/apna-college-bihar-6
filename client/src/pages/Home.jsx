        ...
        <div className="bg-white rounded-[4rem] p-10 md:p-16 border border-slate-200/80 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden group">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="pt-4 flex flex-wrap gap-4">
               <a href="https://github.com/Prince789-student/apna-college-bihar-6/raw/refs/heads/main/server/public/ApnaCollegeBihar-v5.apk" download="ApnaCollegeBihar-v5.apk" className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-[1000] text-[10px] uppercase tracking-widest transition-all shadow-xl shadow-blue-900/40">Download APK Now</a>
