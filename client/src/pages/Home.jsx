      ...
      <nav className="sticky top-0 left-0 w-full z-[100] bg-[#f8fafc]/80 backdrop-blur-xl border-b border-slate-200/50 px-4 md:px-16 py-4 md:py-5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
           ...
           >
             ...
             >
               Features
               <ChevronDown size={12} className={`transition-transform ${showFeaturesMenu ? 'rotate-180' : ''}`} />
             </button>

             {showFeaturesMenu && (
               <div className="absolute left-1/2 top-full z-[2500] mt-5 w-[820px] -translate-x-1/2 rounded-[2rem] border border-slate-200 bg-white/95 p-5 shadow-2xl backdrop-blur-xl">
                 ...
                 <div className="mt-4 flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3">
                   <span className="text-[9px] font-black uppercase tracking-[0.25em] text-slate-500">
                     Complete student toolkit for BEU and Bihar counselling
                   </span>
                   <Link
                     to="/hub"
                     onClick={() => setShowFeaturesMenu(false)}
                     className="flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-[9px] font-black uppercase tracking-widest text-white shadow-lg shadow-blue-900/10"
                   >
