...
const BRANCHES = [
  { id: 'CSE',   label: 'Computer Science',          short: 'CSE',   color: 'amber', emoji: '💻' },
  { id: 'ECE',   label: 'Electronics & Comm.',       short: 'ECE',   color: 'orange', emoji: '📡' },
  { id: 'ME',    label: 'Mechanical Engg.',          short: 'ME',    color: 'red',   emoji: '⚙️' },
  { id: 'CIVIL', label: 'Civil Engineering',         short: 'CIVIL', color: 'lime',  emoji: '🏗️' },
